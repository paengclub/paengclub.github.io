...
let members = [
    ...
    {name:'이성민', rank:'CPL.jpg', dates:['2023-07-10', '2023-09-10', '2024-03-10', '2024-10-01', '2025-04-09', '2025-04-09'], ANF:'공군', isDischarged:'false', isNCO:'false'},
    {name:'문성훈', rank:'CPL.jpg', dates:['2023-07-31', '2023-10-01', '2024-04-01', '2024-10-01', '2025-01-30', '2025-01-30'], ANF:'육군', isDischarged:'false', isNCO:'false'},
    {name:'오강현', rank:'GEN.jpg', dates:['2024-02-01', '2024-04-01', '2024-10-01', '2025-04-01', '2025-10-31', '2025-10-01'], ANF:'공익', isDischarged:'false', isNCO:'false'},
    {name:'김병용', rank:'GEN.jpg', dates:['2024-05-27', '2024-08-01', '2025-02-01', '2025-08-01', '2025-11-26', '2025-11-26'], ANF:'육군', isDischarged:'false', isNCO:'false'},
    {name:'김형빈', rank:'GEN.jpg', dates:['2024-08-05', '2024-10-05', '2025-04-05', '2025-10-05', '2026-05-04', '2026-05-04'], ANF:'공군', isDischarged:'false', isNCO:'false'},
    {name:'김현서', rank:'GEN.jpg', dates:['2024-08-22', '2024-11-01', '2025-05-01', '2025-11-01', '2026-05-22', '2026-05-22'], ANF:'공익', isDischarged:'false', isNCO:'false'},
    {name:'허채민', rank:'PFC.jpg', dates:['2022-10-04', '2023-01-01', '2023-08-01', '2024-02-01', '2024-04-03', '2024-04-03'], ANF:'육군', isDischarged:'true', isNCO:'false'}
];
